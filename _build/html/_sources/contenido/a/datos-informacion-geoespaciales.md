...
Una gran parte de los datos e información disponibles contiene algún tipo de componente geográfico o espacial. Este componente puede expresarse de varias formas. Por ejemplo:
...
- **Coordenadas**: La cima del [Monte Everest](https://es.wikipedia.org/wiki/Monte_Everest) se localiza en las coordenadas geográficas 86°55′31″ E y 27°59′17″ N, como se muestra en la {numref}`figura-mapa-nepal-everest`.

```{figure} img/nepal-map.jpg
:name: figura-mapa-nepal-everest
