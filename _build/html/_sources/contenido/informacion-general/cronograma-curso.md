...
| Semana | Temas | Lecturas |
| :- | :- | :- |
| III-ii (17-23 de enero) | El ecosistema geoespacial de Python<br>- Módulos y paquetes<br>- Ambientes de desarrollo y ejecución<br>&nbsp;&nbsp;- Conda, Anaconda/Miniconda<br>&nbsp;&nbsp;- Jupyter Noteboks<br>&nbsp;&nbsp;- Google Colab, Binder, Kaggle | {cite:p}`severance_py4e_nodate`, {cite:p}`wu_geographic_nodate`, {cite:p}`gandhi_python_2020`, {cite:p}`dorman_spatial_2021` |
